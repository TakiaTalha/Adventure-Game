...
public class AdventureGame implements Serializable {
    ...
    public void setUpGame() throws IOException {
        ...
        if (directoryName.equals("Games/Tutorial")) {
            this.player = new Player(this.rooms.get(11));
        } else {
            this.player = new Player(this.rooms.get(1));
        }
        this.gamescore = new Score(this);
    ...
    public boolean movePlayer(String direction) {
        ...
        blockMap.draw(canvas.getGraphicsContext2D(), room.getRoomName());
        audio.play(roomNumber);
